        ...
        <form onSubmit={placeOrder} className='place-order'>
            ...
            <div className="place-order-right">
                ...
                <div className="payment">
                    ...
                    <div onClick={() => openPopup()} className="payment-option">
                    <BarcodePopup isOpen={isPopupOpen} onClose={closePopup} />
                        <img src={payment === "Barcode" ? assets.checked : assets.un_checked} alt="" />
                        <p>UPI/Barcode</p>
                    </div>
                </div>
